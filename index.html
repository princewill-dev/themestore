               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="section__title-wrapper text-center mb-60">
                        <h2 class="section__title">Featured Themes of The Month</h2>
               ...
               <div class="row">
                     ...
                     <div class="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product__content">
                           <h3 class="product__title product__title2">
                              <a href="#">Zibber - Consulting Business WordPress Theme + RTL</a>
                           </h3>
                           ...
                           <div class="product__meta d-flex justify-content-between align-items-end mt-15">
                              <div class="product__price">
                                 <span>$3.50</span>
                                 <p style="visibility: hidden;">241 Sale</p>
                              </div>
                              <div class="pricing__buy mb-20">
                                 <form action="product-details.html" method="get">
                                    <input type="hidden" value="3.50" name="amount">
                                    <input type="hidden" value="Zibber - Consulting Business WordPress Theme + RTL" name="item">
                                    <button href="#" class="m-btn m-btn-border m-btn-border-5 w-100"> <span></span> Buy Now</button>
                                 </form>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product__content">
                           <h3 class="product__title product__title2">
                              <a href="#">Pixen - Printing Services Company PSD Template</a>
                           </h3>
                           <p class="product__author">by <a href="#">Theme Pure</a> in <a href="#">Templates</a></p>
                           <div class="product__ratings">
                                 <i class="fas fa-star"></i>
                           ...
                           <div class="product__meta d-flex justify-content-between align-items-end mt-15">
                              ...
                              <div class="pricing__buy mb-20">
                                 <form action="product-details.html" method="get">
                                    <input type="hidden" value="2.90" name="amount">
                                    <input type="hidden" value="Pixen - Printing Services Company PSD Template" name="item">
                                    <button href="#" class="m-btn m-btn-border m-btn-border-5 w-100"> <span></span> Buy Now</button>
                                 </form>
                              </div>
                           </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product__content">
                           <h3 class="product__title product__title2">
                              <a href="#">Findup - Directory & Listing PSD Template</a>
                           </h3>
                           <p class="product__author">by <a href="#">Theme Pure</a> in <a href="#">Templates</a></p>
                           <div class="product__ratings">
                                 <i class="fas fa-star"></i>
                           ...
                           <div class="product__meta d-flex justify-content-between align-items-end mt-15">
                              ...
                              <div class="pricing__buy mb-20">
                                 <form action="product-details.html" method="get">
                                    <input type="hidden" value="4.00" name="amount">
                                    <input type="hidden" value="Findup - Directory & Listing PSD Template" name="item">
                                    <button href="#" class="m-btn m-btn-border m-btn-border-5 w-100"> <span></span> Buy Now</button>
                                 </form>
                              </div>
                           </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product__content">
                           <h3 class="product__title product__title2">
                              <a href="#">Agota - Clean Minimal eCommerce HTML5 Template</a>
                           </h3>
                           <p class="product__author">by <a href="#">Theme Pure</a> in <a href="#">Templates</a></p>
                           <div class="product__ratings">
                                 <i class="fas fa-star"></i>
                           ...
                           <div class="product__meta d-flex justify-content-between align-items-end mt-15">
                              ...
                              <div class="pricing__buy mb-20">
                                 <form action="product-details.html" method="get">
                                    <input type="hidden" value="1.60" name="amount">
                                    <input type="hidden" value="Agota - Clean Minimal eCommerce HTML5 Template" name="item">
                                    <button href="#" class="m-btn m-btn-border m-btn-border-5 w-100"> <span></span> Buy Now</button>
                                 </form>
                              </div>
                           </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product__content">
                           <h3 class="product__title product__title2">
                              <a href="#">TechBuzz - IT Solutions WordPress Theme</a>
                           </h3>
                           <p class="product__author">by <a href="#">Theme Pure</a> in <a href="#">Templates</a></p>
                           <div class="product__ratings">
                                 <i class="fas fa-star"></i>
                           ...
                           <div class="product__meta d-flex justify-content-between align-items-end mt-15">
                              ...
                              <div class="pricing__buy mb-20">
                                 <form action="product-details.html" method="get">
                                    <input type="hidden" value="3.00" name="amount">
                                    <input type="hidden" value="TechBuzz - IT Solutions WordPress Theme" name="item">
                                    <button href="#" class="m-btn m-btn-border m-btn-border-5 w-100"> <span></span> Buy Now</button>
                                 </form>
                              </div>
                           </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product__content">
                           <h3 class="product__title product__title2">
                              <a href="#">BildPress - Construction WordPress Theme + RTL</a>
                           </h3>
                           <p class="product__author">by <a href="#">Theme Pure</a> in <a href="#">Templates</a></p>
                           <div class="product__ratings">
                                 <i class="fas fa-star"></i>
                           ...
                           <div class="product__meta d-flex justify-content-between align-items-end mt-15">
                              ...
                              <div class="pricing__buy mb-20">
                                 <form action="product-details.html" method="get">
                                    <input type="hidden" value="1.45" name="amount">
                                    <input type="hidden" value="BildPress - Construction WordPress Theme + RTL" name="item">
                                    <button href="#" class="m-btn m-btn-border m-btn-border-5 w-100"> <span></span> Buy Now</button>
                                 </form>
                              </div>
                           </div>
